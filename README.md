...
Na wizualizacje można klikać myszką i zaznaczać pojedyńcze ```Node```'y. W skrypcie można uzyskać zaznaczony ```Node``` przez wywołanie funkcji ```GetSelectedNode()``` na wizualizacji. Funkcja ta zwraca zaznaczony węzeł lub null jeżeli nic nie jest zaznaczone.

<img width="1239" height="665" alt="8" src="https://github.com/user-attachments/assets/dd6ec3b2-1e12-40ec-91e8-60e46fede705" />
